...
Welcome to my repository showcasing the projects and tasks I completed during my internship at **CodSoft**. This repository serves as a track record of my technical progress, problem-solving abilities, and hands-on experience.

## 📌 Repository Overview
This repository contains my solutions to the 5 internship tasks assigned by CodSoft. Each project is organized into its own folder, demonstrating modular code design and clean software development practices.
...
### 3. 📂 [Task 3: Password Generator](Password_Generator)
...
### 4. 📂 [Task 4: Rock-Paper-Scissors Game](Rock-Paper-Scissors_Game)
